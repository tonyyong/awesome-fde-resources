...
- [FDE Role, Interview, Demo, and Communication](resources/01-fde-role-interview-demo-communication.md)
- [Use-Case Selection and Customer Discovery](resources/02-use-case-selection-customer-discovery.md)
- [Solution Architecture and System Design](resources/03-solution-architecture-system-design.md)
- [AI Application Engineering](resources/04-ai-application-engineering.md)
- [Knowledge, RAG, and Domain Data](resources/05-knowledge-rag-domain-data.md)
...
- Add playbooks and templates once the artifact structure is mature enough.
...
The original writing and resource notes in this repo are licensed under [CC BY 4.0](LICENSE). Linked resources keep their own licenses and terms. CC BY 4.0 was chosen because this is primarily educational writing and resource curation, not software code.
